namespace DataTableCreateLibraryTests
{
    ...
    public class TableWorkUnitTest
    {
        ...
        [DataRow("test1 string;test2 int;test3 DateTime;test4 float;test2 float;test2 DateTime;test5 string;test2 string;test2 DateTime; test6 string", "test2", "15 но€бр€ 2017", new int[] { 5, 7, 8 })]
